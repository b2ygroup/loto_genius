...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let splashProgressBarFill = accessibleSplashScreen ? accessibleSplashScreen.querySelector('.progress-bar-fill') : null;
    let splashProgressContainer = accessibleSplashScreen ? accessibleSplashScreen.querySelector('.progress-bar-container') : null;
